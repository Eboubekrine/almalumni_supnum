...
export const translations = {
    EN: {
        ...
        dashboard: {
            nav: { dashboard: 'Dashboard', profile: 'Profile', users: 'Alumnis', friends: 'Network', messages: 'Messages', myOffers: 'My Offers' },
            welcome: 'Welcome,',
            welcomeSubtitle: "Here's what's happening in your SupNum network.",
            stats: { totalUsers: 'Total Users', friends: 'Connections', pending: 'Pending Requests', growth: 'this month' },
        ...
        auth: {
            ...
            signUp: {
                ...
                role: 'Role',
                domaine: 'Domain',
                selectDomaine: '-- Select --',
                alumniNotice: 'Alumni accounts require admin validation before you can log in.',
                pendingValidation: 'Registration successful. Your account is pending admin validation.',
        ...
        friends: {
            title: 'Network',
            tabs: { mine: 'My Connections', requests: 'Requests' },
            message: 'Message',
            noFriends: 'No connections yet. Grow your network!',
            sentRequest: 'Sent you a connection request',
            accept: 'Accept',
            reject: 'Reject',
            noRequests: 'No pending requests.',
            acceptedAlert: 'Connection request accepted!',
            rejectedAlert: 'Connection request rejected',
    ...
    FR: {
        ...
        dashboard: {
            nav: { dashboard: 'Tableau de bord', profile: 'Profil', users: 'Alumnis', friends: 'Mon Réseau', messages: 'Messages', myOffers: 'Mes Offres' },
            welcome: 'Bienvenue,',
            welcomeSubtitle: "Voici ce qui se passe dans votre réseau SupNum.",
            stats: { totalUsers: 'Total Utilisateurs', friends: 'Connexions', pending: 'Demandes en attente', growth: 'ce mois' },
            quickLinks: { findUsers: 'Trouver des gens', messages: 'Messages', events: 'Événements', viewProfile: 'Voir le profil' },
            friendRequests: "Demandes de réseau",
            suggestions: 'Suggestions',
            viewMore: 'Voir plus',
        ...
        auth: {
            ...
            signUp: {
                ...
                role: 'Rôle',
                domaine: 'Domaine',
                selectDomaine: '-- Choisir --',
                alumniNotice: 'Les comptes Alumni nécessitent une validation par l\'administrateur avant de pouvoir se connecter.',
                pendingValidation: 'Inscription réussie. Votre compte est en attente de validation par l\'administrateur.',
        ...
        friends: {
            title: 'Mon Réseau',
            tabs: { mine: 'Mes Connexions', requests: 'Demandes' },
            message: 'Message',
            noFriends: 'Pas encore de connexions. Développez votre réseau !',
            sentRequest: 'Vous a envoyé une demande de connexion',
            accept: 'Accepter',
            reject: 'Refuser',
            noRequests: 'Aucune demande en attente.',
            acceptedAlert: 'Demande de connexion acceptée !',
            rejectedAlert: 'Demande de connexion refusée',
    ...
    AR: {
        ...
        dashboard: {
            nav: { dashboard: 'لوحة التحكم', profile: 'الملف الشخصي', users: 'الخريجون (Alumnis)', friends: 'شبكتي', messages: 'الرسائل', myOffers: 'عروضي' },
            welcome: 'مرحبًا،',
            welcomeSubtitle: 'إليك ما يحدث في شبكة SupNum الخاصة بك.',
            stats: { totalUsers: 'إجمالي المستخدمين', friends: 'جهات الاتصال', pending: 'طلبات معلقة', growth: 'هذا الشهر' },
            quickLinks: { findUsers: 'البحث عن مستخدمين', messages: 'الرسائل', events: 'الأحداث', viewProfile: 'عرض الملف الشخصي' },
            friendRequests: 'طلبات التواصل',
        ...
        auth: {
            ...
            signUp: {
                ...
                role: 'الدور',
                domaine: 'التخصص',
                selectDomaine: '-- اختيار --',
                alumniNotice: 'حسابات الخريجين تتطلب موافقة المسؤول قبل تسجيل الدخول.',
                pendingValidation: 'تم التسجيل بنجاح. حسابك في انتظار موافقة المسؤول.',
                button: 'إنشاء حساب',
        ...
        friends: {
            title: 'شبكتي',
            tabs: { mine: 'شبكتي', requests: 'الطلبات' },
            message: 'رسالة',
            noFriends: 'لا توجد جهات اتصال بعد. ابدأ ببناء شبكتك!',
            sentRequest: 'أرسل لك طلب تواصل',
            accept: 'قبول',
            reject: 'رفض',
            noRequests: 'لا توجد طلبات معلقة.',
            acceptedAlert: 'تم قبول طلب التواصل!',
            rejectedAlert: 'تم رفض طلب التواصل',
            failedAlert: 'فشل معالجة الطلب'
        },
        search: {
            title: 'الخريجون (Alumnis)',
